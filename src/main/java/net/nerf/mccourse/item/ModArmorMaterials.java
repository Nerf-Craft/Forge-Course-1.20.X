...
public enum ModArmorMaterials implements ArmorMaterial {
    ALEXANDRITE("alexandrite", 50, (EnumMap)Util.make(new EnumMap(ArmorItem.Type.class), (p_266655_) -> {
    ...
    ModArmorMaterials(String name, int durabilityMultiplier, EnumMap<ArmorItem.Type, Integer> protectionTypeMap,
                      int enchantmentValue, SoundEvent soundEvent, float toughness, float knockbackResistance, Supplier repairMaterial) {
        this.name = name;
