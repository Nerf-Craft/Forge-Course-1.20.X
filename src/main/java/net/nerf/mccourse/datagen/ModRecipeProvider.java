...
import net.nerf.mccourse.datagen.custom.GemEmpoweringRecipeBuilder;
...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    private static final List<ItemLike> ALEXANDRITE_SMELTABLES = List.of(ModItems.RAW_ALEXANDRITE.get(), ModBlocks.ALEXANDRITE_ORE.get(),
            ModBlocks.NETHER_ALEXANDRITE_ORE.get(), ModBlocks.DEEPSLATE_ALEXANDRITE_ORE.get(), ModBlocks.END_ALEXANDRITE_ORE.get());
    ...
    protected void buildRecipes(Consumer<FinishedRecipe> pWriter) {
        ...
        new GemEmpoweringRecipeBuilder(Items.COAL_BLOCK, Items.DIAMOND, 1)
                .unlockedBy("has_raw_alexandrite", has(Items.COAL_BLOCK)).save(pWriter);
