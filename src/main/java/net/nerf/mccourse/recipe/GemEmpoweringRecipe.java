...
public class GemEmpoweringRecipe implements Recipe<SimpleContainer> {
    ...
    public static class Serializer implements RecipeSerializer<GemEmpoweringRecipe> {
        ...
        @Override
        public GemEmpoweringRecipe fromJson(ResourceLocation id, JsonObject jsonObject) {
        ...
        @Override
        public @Nullable GemEmpoweringRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buf) {
